...
typedef struct _sai_dash_meter_api_t {
    sai_status_t create_meter_bucket(_Out_ sai_object_id_t *meter_bucket_id, _In_ sai_object_id_t switch_id, _In_ uint32_t attr_count, _In_ const sai_attribute_t *attr_list);
    sai_status_t remove_meter_bucket(_In_ sai_object_id_t meter_bucket_id);
    sai_status_t set_meter_bucket_attribute(_In_ sai_object_id_t meter_bucket_id, _In_ const sai_attribute_t *attr);
    sai_status_t get_meter_bucket_attribute(_In_ sai_object_id_t meter_bucket_id, _In_ uint32_t attr_count, _Inout_ sai_attribute_t *attr_list);
    sai_status_t get_meter_bucket_stats(_In_ sai_object_id_t meter_bucket_id, _In_ uint32_t number_of_counters, _In_ const sai_stat_id_t *counter_ids, _Out_ uint64_t *counters);
    sai_status_t get_meter_bucket_stats_ext(_In_ sai_object_id_t meter_bucket_id, _In_ uint32_t number_of_counters, _In_ const sai_stat_id_t *counter_ids, _In_ sai_stats_mode_t mode, _Out_ uint64_t *counters);
    sai_status_t clear_meter_bucket_stats(_In_ sai_object_id_t meter_bucket_id, _In_ uint32_t number_of_counters, _In_ const sai_stat_id_t *counter_ids);
    sai_status_t create_meter_buckets(_In_ sai_object_id_t switch_id, _In_ uint32_t object_count, _In_ const uint32_t *attr_count, _In_ const sai_attribute_t **attr_list, _In_ sai_bulk_op_error_mode_t mode, _Out_ sai_object_id_t *object_id, _Out_ sai_status_t *object_statuses);
    sai_status_t remove_meter_buckets(_In_ uint32_t object_count, _In_ const sai_object_id_t *object_id, _In_ sai_bulk_op_error_mode_t mode, _Out_ sai_status_t *object_statuses);
