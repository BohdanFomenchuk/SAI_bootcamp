...
void custom_range_test(void)
{
    ...
    TEST_ASSERT_TRUE(SAI_METER_BUCKET_ATTR_CUSTOM_RANGE_START == 0x10000000, "invalid custom range start for METER_BUCKET");
    TEST_ASSERT_TRUE(SAI_METER_BUCKET_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for METER_BUCKET");
...
void enum_size_check_test(void)
{
    ...
    TEST_ASSERT_TRUE((sizeof(sai_meter_bucket_attr_t) == sizeof(int32_t)), "invalid enum sai_meter_bucket_attr_t size");
    TEST_ASSERT_TRUE((sizeof(sai_meter_bucket_stat_t) == sizeof(int32_t)), "invalid enum sai_meter_bucket_stat_t size");
...
void api_name_test(void)
{
    ...
    }
    {
        ...
        dummy = &ge;
        dummy = NULL;
        checked[(int)SAI_OBJECT_TYPE_ARS_PROFILE] = SAI_OBJECT_TYPE_ARS_PROFILE;
    }
    {
        ...
        dummy = &ge;
        dummy = NULL;
        checked[(int)SAI_OBJECT_TYPE_ARS] = SAI_OBJECT_TYPE_ARS;
    }
    {
        sai_acl_api_t acl_api = { 0 };
        ...
        dummy = &ge;
        dummy = NULL;
        checked[(int)SAI_OBJECT_TYPE_ACL_TABLE_CHAIN_GROUP] = SAI_OBJECT_TYPE_ACL_TABLE_CHAIN_GROUP;
    }
    {
    ...
    }
    {
        ...
        dummy = &ge;
        dummy = NULL;
        checked[(int)SAI_OBJECT_TYPE_TAM_COUNTER_SUBSCRIPTION] = SAI_OBJECT_TYPE_TAM_COUNTER_SUBSCRIPTION;
    }
    {
        ...
        dummy = &ge;
        dummy = NULL;
        checked[(int)SAI_OBJECT_TYPE_POE_DEVICE] = SAI_OBJECT_TYPE_POE_DEVICE;
    }
    {
        sai_poe_api_t poe_api = { 0 };
        ...
        dummy = &ge;
        dummy = NULL;
        checked[(int)SAI_OBJECT_TYPE_POE_PSE] = SAI_OBJECT_TYPE_POE_PSE;
    }
    {
        sai_poe_api_t poe_api = { 0 };
        ...
        dummy = &ge;
        dummy = NULL;
        checked[(int)SAI_OBJECT_TYPE_POE_PORT] = SAI_OBJECT_TYPE_POE_PORT;
    }
    {
    ...
    }
    {
        ...
        dummy = &ge;
        dummy = NULL;
        checked[(int)SAI_OBJECT_TYPE_DASH_ACL_GROUP] = SAI_OBJECT_TYPE_DASH_ACL_GROUP;
    }
    {
        sai_dash_acl_api_t dash_acl_api = { 0 };
        ...
        dummy = &ge;
        dummy = NULL;
        checked[(int)SAI_OBJECT_TYPE_DASH_ACL_RULE] = SAI_OBJECT_TYPE_DASH_ACL_RULE;
    }
    {
        ...
        dummy = &ge;
        dummy = NULL;
        checked[(int)SAI_OBJECT_TYPE_DIRECTION_LOOKUP_ENTRY] = SAI_OBJECT_TYPE_DIRECTION_LOOKUP_ENTRY;
    }
    {
        ...
        dummy = &ge;
        dummy = NULL;
        checked[(int)SAI_OBJECT_TYPE_ENI_ETHER_ADDRESS_MAP_ENTRY] = SAI_OBJECT_TYPE_ENI_ETHER_ADDRESS_MAP_ENTRY;
    }
    {
        sai_dash_eni_api_t dash_eni_api = { 0 };
        ...
        dummy = &ge;
        dummy = NULL;
        checked[(int)SAI_OBJECT_TYPE_ENI] = SAI_OBJECT_TYPE_ENI;
    }
    {
        ...
        dummy = &ge;
        dummy = NULL;
        checked[(int)SAI_OBJECT_TYPE_INBOUND_ROUTING_ENTRY] = SAI_OBJECT_TYPE_INBOUND_ROUTING_ENTRY;
    }
    {
        sai_dash_meter_api_t dash_meter_api = { 0 };
        sai_generic_create_fn create = dash_meter_api.create_meter_bucket;
        sai_generic_remove_fn remove = dash_meter_api.remove_meter_bucket;
        sai_generic_set_fn set = dash_meter_api.set_meter_bucket_attribute;
        sai_generic_get_fn get = dash_meter_api.get_meter_bucket_attribute;
        sai_create_meter_bucket_fn cr = NULL;
        sai_remove_meter_bucket_fn re = NULL;
        sai_set_meter_bucket_attribute_fn se = NULL;
        sai_get_meter_bucket_attribute_fn ge = NULL;
        dummy = &create;
        dummy = &remove;
        dummy = &set;
        dummy = &get;
        ...
        dummy = &ge;
        dummy = NULL;
        checked[(int)SAI_OBJECT_TYPE_METER_BUCKET] = SAI_OBJECT_TYPE_METER_BUCKET;
    }
    {
        sai_dash_meter_api_t dash_meter_api = { 0 };
        ...
        dummy = &ge;
        dummy = NULL;
        checked[(int)SAI_OBJECT_TYPE_METER_POLICY] = SAI_OBJECT_TYPE_METER_POLICY;
    }
    {
        sai_dash_meter_api_t dash_meter_api = { 0 };
        ...
        dummy = &ge;
        dummy = NULL;
        checked[(int)SAI_OBJECT_TYPE_METER_RULE] = SAI_OBJECT_TYPE_METER_RULE;
    }
    {
        ...
        dummy = &ge;
        dummy = NULL;
        checked[(int)SAI_OBJECT_TYPE_OUTBOUND_CA_TO_PA_ENTRY] = SAI_OBJECT_TYPE_OUTBOUND_CA_TO_PA_ENTRY;
    }
    {
        ...
        dummy = &ge;
        dummy = NULL;
        checked[(int)SAI_OBJECT_TYPE_OUTBOUND_ROUTING_ENTRY] = SAI_OBJECT_TYPE_OUTBOUND_ROUTING_ENTRY;
    }
    {
        ...
        dummy = &ge;
        dummy = NULL;
        checked[(int)SAI_OBJECT_TYPE_VNET] = SAI_OBJECT_TYPE_VNET;
    }
    {
        ...
        dummy = &ge;
        dummy = NULL;
        checked[(int)SAI_OBJECT_TYPE_PA_VALIDATION_ENTRY] = SAI_OBJECT_TYPE_PA_VALIDATION_ENTRY;
    }
    {
    ...
    }
    {
        ...
        dummy = &ge;
        dummy = NULL;
        checked[(int)SAI_OBJECT_TYPE_HA_SET] = SAI_OBJECT_TYPE_HA_SET;
    }
    {
        sai_dash_ha_api_t dash_ha_api = { 0 };
        ...
        dummy = &ge;
        dummy = NULL;
        checked[(int)SAI_OBJECT_TYPE_HA_SCOPE] = SAI_OBJECT_TYPE_HA_SCOPE;
    }
...
void statenum_defined(void)
{
    ...
    TEST_ASSERT_TRUE(sai_metadata_object_type_info_SAI_OBJECT_TYPE_METER_BUCKET.statenum != NULL, "statenum field for object SAI_OBJECT_TYPE_METER_BUCKET must be populated");
...
void custom_range_all_test(void)
{
    ...
    TEST_ASSERT_TRUE(SAI_ACL_COUNTER_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_ACL_COUNTER_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_ACL_ENTRY_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_ACL_ENTRY_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_ACL_RANGE_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_ACL_RANGE_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_ACL_TABLE_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_ACL_TABLE_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_ACL_TABLE_CHAIN_GROUP_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_ACL_TABLE_CHAIN_GROUP_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_ACL_TABLE_GROUP_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_ACL_TABLE_GROUP_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_ACL_TABLE_GROUP_MEMBER_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_ACL_TABLE_GROUP_MEMBER_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_ARS_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_ARS_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_ARS_PROFILE_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_ARS_PROFILE_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_BFD_SESSION_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_BFD_SESSION_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_BRIDGE_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_BRIDGE_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_BRIDGE_PORT_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_BRIDGE_PORT_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_BUFFER_POOL_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_BUFFER_POOL_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_BUFFER_PROFILE_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_BUFFER_PROFILE_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_COUNTER_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_COUNTER_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_DASH_ACL_GROUP_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_DASH_ACL_GROUP_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_DASH_ACL_RULE_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_DASH_ACL_RULE_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_DEBUG_COUNTER_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_DEBUG_COUNTER_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_DIRECTION_LOOKUP_ENTRY_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_DIRECTION_LOOKUP_ENTRY_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_DTEL_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_DTEL_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_DTEL_EVENT_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_DTEL_EVENT_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_DTEL_INT_SESSION_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_DTEL_INT_SESSION_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_DTEL_QUEUE_REPORT_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_DTEL_QUEUE_REPORT_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_DTEL_REPORT_SESSION_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_DTEL_REPORT_SESSION_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_ENI_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_ENI_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_ENI_ETHER_ADDRESS_MAP_ENTRY_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_ENI_ETHER_ADDRESS_MAP_ENTRY_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_FDB_ENTRY_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_FDB_ENTRY_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_FDB_FLUSH_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_FDB_FLUSH_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_FINE_GRAINED_HASH_FIELD_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_FINE_GRAINED_HASH_FIELD_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_GENERIC_PROGRAMMABLE_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_GENERIC_PROGRAMMABLE_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_HA_SCOPE_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_HA_SCOPE_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_HA_SET_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_HA_SET_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_HASH_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_HASH_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_HOSTIF_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_HOSTIF_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_HOSTIF_PACKET_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_HOSTIF_PACKET_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_HOSTIF_TABLE_ENTRY_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_HOSTIF_TABLE_ENTRY_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_HOSTIF_TRAP_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_HOSTIF_TRAP_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_HOSTIF_TRAP_GROUP_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_HOSTIF_TRAP_GROUP_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_HOSTIF_USER_DEFINED_TRAP_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_HOSTIF_USER_DEFINED_TRAP_ATTR_CUSTOM_RANGE_END");
    TEST_ASSERT_TRUE(SAI_IN_DROP_REASON_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_IN_DROP_REASON_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_INBOUND_ROUTING_ENTRY_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_INBOUND_ROUTING_ENTRY_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_INGRESS_PRIORITY_GROUP_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_INGRESS_PRIORITY_GROUP_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_INSEG_ENTRY_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_INSEG_ENTRY_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_IPMC_ENTRY_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_IPMC_ENTRY_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_IPMC_GROUP_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_IPMC_GROUP_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_IPMC_GROUP_MEMBER_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_IPMC_GROUP_MEMBER_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_IPSEC_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_IPSEC_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_IPSEC_PORT_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_IPSEC_PORT_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_IPSEC_SA_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_IPSEC_SA_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_ISOLATION_GROUP_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_ISOLATION_GROUP_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_ISOLATION_GROUP_MEMBER_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_ISOLATION_GROUP_MEMBER_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_L2MC_ENTRY_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_L2MC_ENTRY_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_L2MC_GROUP_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_L2MC_GROUP_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_L2MC_GROUP_MEMBER_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_L2MC_GROUP_MEMBER_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_LAG_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_LAG_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_LAG_MEMBER_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_LAG_MEMBER_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_MACSEC_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_MACSEC_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_MACSEC_FLOW_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_MACSEC_FLOW_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_MACSEC_PORT_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_MACSEC_PORT_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_MACSEC_SA_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_MACSEC_SA_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_MACSEC_SC_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_MACSEC_SC_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_MCAST_FDB_ENTRY_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_MCAST_FDB_ENTRY_ATTR_CUSTOM_RANGE_END");
    TEST_ASSERT_TRUE(SAI_METER_BUCKET_ATTR_CUSTOM_RANGE_START == 0x10000000, "invalid custom range start for SAI_METER_BUCKET_ATTR_CUSTOM_RANGE_START");
    TEST_ASSERT_TRUE(SAI_METER_BUCKET_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_METER_BUCKET_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_METER_POLICY_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_METER_POLICY_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_METER_RULE_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_METER_RULE_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_MIRROR_SESSION_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_MIRROR_SESSION_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_MY_MAC_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_MY_MAC_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_MY_SID_ENTRY_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_MY_SID_ENTRY_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_MY_SID_ENTRY_ENDPOINT_BEHAVIOR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_MY_SID_ENTRY_ENDPOINT_BEHAVIOR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_NAT_ENTRY_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_NAT_ENTRY_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_NAT_ZONE_COUNTER_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_NAT_ZONE_COUNTER_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_NEIGHBOR_ENTRY_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_NEIGHBOR_ENTRY_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_NEXT_HOP_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_NEXT_HOP_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_NEXT_HOP_GROUP_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_NEXT_HOP_GROUP_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_NEXT_HOP_GROUP_MAP_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_NEXT_HOP_GROUP_MAP_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_NEXT_HOP_GROUP_MEMBER_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_NEXT_HOP_GROUP_MEMBER_ATTR_CUSTOM_RANGE_END");
    TEST_ASSERT_TRUE(SAI_OUT_DROP_REASON_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_OUT_DROP_REASON_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_OUTBOUND_CA_TO_PA_ENTRY_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_OUTBOUND_CA_TO_PA_ENTRY_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_OUTBOUND_ROUTING_ENTRY_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_OUTBOUND_ROUTING_ENTRY_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_PA_VALIDATION_ENTRY_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_PA_VALIDATION_ENTRY_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_POE_DEVICE_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_POE_DEVICE_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_POE_PORT_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_POE_PORT_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_POE_PSE_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_POE_PSE_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_POLICER_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_POLICER_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_PORT_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_PORT_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_PORT_CONNECTOR_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_PORT_CONNECTOR_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_PORT_POOL_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_PORT_POOL_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_PORT_SERDES_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_PORT_SERDES_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_QOS_MAP_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_QOS_MAP_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_QUEUE_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_QUEUE_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_ROUTE_ENTRY_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_ROUTE_ENTRY_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_ROUTER_INTERFACE_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_ROUTER_INTERFACE_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_RPF_GROUP_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_RPF_GROUP_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_RPF_GROUP_MEMBER_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_RPF_GROUP_MEMBER_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_SAMPLEPACKET_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_SAMPLEPACKET_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_SCHEDULER_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_SCHEDULER_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_SCHEDULER_GROUP_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_SCHEDULER_GROUP_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_SRV6_SIDLIST_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_SRV6_SIDLIST_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_STP_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_STP_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_STP_PORT_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_STP_PORT_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_SWITCH_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_SWITCH_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_SWITCH_TUNNEL_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_SWITCH_TUNNEL_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_SYSTEM_PORT_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_SYSTEM_PORT_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_TABLE_BITMAP_CLASSIFICATION_ENTRY_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_TABLE_BITMAP_CLASSIFICATION_ENTRY_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_TABLE_BITMAP_ROUTER_ENTRY_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_TABLE_BITMAP_ROUTER_ENTRY_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_TABLE_META_TUNNEL_ENTRY_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_TABLE_META_TUNNEL_ENTRY_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_TAM_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_TAM_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_TAM_COLLECTOR_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_TAM_COLLECTOR_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_TAM_COUNTER_SUBSCRIPTION_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_TAM_COUNTER_SUBSCRIPTION_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_TAM_EVENT_ACTION_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_TAM_EVENT_ACTION_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_TAM_EVENT_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_TAM_EVENT_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_TAM_EVENT_THRESHOLD_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_TAM_EVENT_THRESHOLD_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_TAM_INT_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_TAM_INT_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_TAM_MATH_FUNC_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_TAM_MATH_FUNC_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_TAM_REPORT_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_TAM_REPORT_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_TAM_TEL_TYPE_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_TAM_TEL_TYPE_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_TAM_TELEMETRY_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_TAM_TELEMETRY_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_TAM_TRANSPORT_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_TAM_TRANSPORT_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_TUNNEL_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_TUNNEL_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_TUNNEL_MAP_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_TUNNEL_MAP_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_TUNNEL_MAP_ENTRY_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_TUNNEL_MAP_ENTRY_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_TUNNEL_TERM_TABLE_ENTRY_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_TUNNEL_TERM_TABLE_ENTRY_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_TWAMP_SESSION_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_TWAMP_SESSION_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_UDF_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_UDF_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_UDF_GROUP_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_UDF_GROUP_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_UDF_MATCH_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_UDF_MATCH_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_VIP_ENTRY_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_VIP_ENTRY_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_VIRTUAL_ROUTER_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_VIRTUAL_ROUTER_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_VLAN_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_VLAN_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_VLAN_MEMBER_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_VLAN_MEMBER_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_VNET_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_VNET_ATTR_CUSTOM_RANGE_END");
    ...
    TEST_ASSERT_TRUE(SAI_WRED_ATTR_CUSTOM_RANGE_END > 0x10000000, "invalid custom range end for SAI_WRED_ATTR_CUSTOM_RANGE_END");
}
#pragma GCC diagnostic pop
int main()
{
    printf("Executing Test [1/14]: non_object_id_test\n");
    non_object_id_test();
    printf("Executing Test [2/14]: switch_id_position_test\n");
    switch_id_position_test();
    printf("Executing Test [3/14]: custom_range_test\n");
    custom_range_test();
    printf("Executing Test [4/14]: check_pointer_names_test\n");
    check_pointer_names_test();
    printf("Executing Test [5/14]: enum_size_check_test\n");
    enum_size_check_test();
    printf("Executing Test [6/14]: list_count_test\n");
    list_count_test();
    printf("Executing Test [7/14]: api_name_test\n");
    api_name_test();
    printf("Executing Test [8/14]: struct_list_test\n");
    struct_list_test();
    printf("Executing Test [9/14]: serialize_structs\n");
    serialize_structs();
    printf("Executing Test [10/14]: serialize_unions\n");
    serialize_unions();
    printf("Executing Test [11/14]: statenum_defined\n");
    statenum_defined();
    printf("Executing Test [12/14]: api_implemented\n");
    api_implemented();
    printf("Executing Test [13/14]: struct_union_size\n");
    struct_union_size();
    printf("Executing Test [14/14]: custom_range_all_test\n");
